...
class HomepageDocInfo(models.Model):
    ...
    물리 테이블 homepage_doc_info, doc_type당 1행·총 7행(UNIQUE) 고정.
    """
    ...
    doc_type = models.CharField(
        ...
        db_comment=(
            ...
            'seminar_copyright(세미나 저작권), recommended_search(추천검색어). 행당 UNIQUE.'
        ),
    )
    title = models.CharField(
        ...
        blank=True,
        db_comment=(
            'www 페이지 제목·메타 등 표시용. NULL 허용. recommended_search는 관리자 저장 시 title=search 고정 관례.'
        ),
    )
